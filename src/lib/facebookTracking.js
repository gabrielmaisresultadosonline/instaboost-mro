 ...
 */
export const trackFacebookEvent = async (eventName, customData) => {
    try {
 ...
 */
export const trackLead = (leadSource, userData) => {
 ...
 */
export const trackInitiateCheckout = (productName, value, userData) => {
 ...
 */
export const trackViewContent = (contentName, category) => {
 ...
 */
export const trackPurchase = (value, productName, email, eventId) => {
