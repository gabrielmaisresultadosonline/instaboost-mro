...
const RendaExtraLeadAdmin = () => {
  ...
  useEffect(() => {
    const savedToken = localStorage.getItem("renda_extra_lead_admin_token");
    if (savedToken) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      localStorage.setItem("renda_extra_lead_admin_token", response.data.adminToken);
...
export default RendaExtraLeadAdmin;
