        ...
        <div className="max-w-5xl mx-auto">
          ...
          {(() => {
            ...
            return (
              <>
                <div className="relative">
                  <div className="flex gap-3 sm:gap-4 overflow-x-auto pb-4 snap-x snap-mandatory scrollbar-hide" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
                    {feedbackVideos.map((video, i) => (
                      <div
                        key={i}
                ...
                <p className="text-center text-gray-500 text-xs mt-3">
                  ← Arraste para ver mais feedbacks →
                </p>
              </>
            );
          })()}
